...
export default function ChatInput({
  ...
  return (
    <>
      ...
      {/*
        .ai-input-glow wrapper — no padding, no fill.
          ::before  = thin 1.5px moving conic border (mask-composite:exclude)
          ::after   = same border but blurred, radiates the glow outward
        .ai-input-inner.pill — the actual pill; glass-input handles its own bg.
      */}
      <div
      ...
      <div className="hidden md:block border-t border-[var(--glass-border)] bg-[var(--tab-float-bg)] px-4 pb-3 pt-3 backdrop-blur-xl saturate-150">
        <div className="mx-auto flex max-w-3xl items-end gap-2">
          {/*
            Wrapper: ai-input-glow draws the thin border ring + glow.
            The textarea inside keeps its own rounded border / bg untouched.
          */}
          <textarea
            ref={textareaRef}
            value={value}
